---
name: yt-add-channel
description: Ajoute une chaîne YouTube entière au corpus : résout la liste de vidéos (filtre année optionnel), télécharge transcripts + insights dans output/<slug>/, déduplique les pistes de langue, puis régénère le catalogue global. Usage : /yt-add-channel [URL chaîne] [slug] [années]
---
