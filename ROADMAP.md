...
| Interface web locale | Implémentée | Français et anglais, détection du navigateur, choix persistant, identité warm technical, thème sombre par défaut, parcours guidé en 5 étapes, Astro statique packagé sur `127.0.0.1`, aucun partage distant |
...
| Qualité locale | `PASS` | 1 089 tests Python + 10 subtests, 162 tests frontend, 6 parcours Playwright, Ruff complet, Mypy sur 53 fichiers, build web reproductible sur 20 fichiers, Astro Check sur 57 fichiers et diff-check |
...
subtests, `162` tests frontend, `6` parcours Playwright, Ruff sur
`src tests scripts`, Mypy sur les 53 fichiers de `src`, Astro Check sur 57
